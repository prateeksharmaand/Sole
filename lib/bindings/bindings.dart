...
class UBindings extends Bindings {
  ...
  void dependencies() {
     ...
     Get.lazyPut<CommunicationPreferencesController>(() => CommunicationPreferencesController(),fenix: true);
     Get.lazyPut<ReportsController>(() => ReportsController(),fenix: true);
     Get.lazyPut<AssetsController>(() => AssetsController(),fenix: true);
     Get.lazyPut<BalanceSheetController>(() => BalanceSheetController(),fenix: true);
